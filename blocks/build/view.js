...
(() => {
/*!*************************************************!*\
  !*** ./assets/js/payment-method-borgun/view.js ***!
  \*************************************************/
...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_3__.getPaymentMethodData)('borgun', {});
const defaultLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Teya', 'borgun_woocommerce');
 ...
 */
const Content = () => {
  return (0,_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__.decodeEntities)(settings.description || '');
};
...
/**
 * Teya payment method config object.
 */
const BorgunPaymentMethod = {
  name: 'borgun',
...
(0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_1__.registerPaymentMethod)(BorgunPaymentMethod);
})();
